...
export default function CategoryJobSummary() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/CategoryJobSummary.php";
        setIsLoading(true);
   ...
   useEffect(() => {
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Category Job Summary Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
                ...
                doc.setFont(getfontstyle, 'bold'); // Set font to bold
                doc.text(`CATEGORY :`, labelsX, labelsY + 8.5); // Draw bold label
        ...
        // Save the PDF files
        doc.save(`CategoryJobSummaryReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Category Job Summary Report From ${fromInputDate} To ${toInputDate}`]);
        ...
        // Set column widths
        [12, 25, 14, 14, 14, 14, 14, 14, 14, 14, 14].forEach((width, index) => {
        ...
        saveAs(blob, `CategoryJobSummaryReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Category Job Summary Report" />
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="d-flex align-items-center  " style={{ marginLeft: '28px' }}>
                                <div style={{ width: '90x', display: 'flex', justifyContent: 'end' }}>
                                    <label htmlFor="fromDatePicker"><span style={{ fontFamily: getfontstyle, fontSize: getdatafontsize, fontWeight: 'bold' }}>Company :</span>  <br /></label>
                                </div>
