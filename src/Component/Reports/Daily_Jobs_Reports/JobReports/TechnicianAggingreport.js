...
export default function TechnicianAggingReport() {
    ...
    const [TotalTenPlus, setTotalTenPlus] = useState(0);
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/TechnicianAgging.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [20, 50, 20, 20, 20, 20, 20, 20, 20, 20];
        ...
        const addTableRows = (startX, startY, startIndex, endIndex) => {
            ...
            for (let i = startIndex; i < endIndex; i++) {
                ...
                row.forEach((cell, cellIndex) => {
                    ...
                    if (cellIndex === 2 || cellIndex === 3 || cellIndex === 4 || cellIndex === 5 || cellIndex === 6 || cellIndex === 7 || cellIndex === 8 || cellIndex === 9) {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Technician Agging Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`TechnicianAggingReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Technician Agging Report From ${fromInputDate} To ${toInputDate}`]);
        ...
        // Set column widths
        [10, 20, 12,12,12,12,12,12,12,12].forEach((width, index) => {
        ...
        totalRow.eachCell((cell, colNumber) => {
            ...
            if (
                ...
                colNumber === 3 || colNumber === 4 || colNumber === 5 || colNumber === 6 || colNumber === 7 || colNumber === 10
            ) {
        ...
        saveAs(blob, `TechnicianAggingReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Technician Agging Report" />
                    ...
                    >
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalTwo}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalFive}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalSeven}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalTen}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalTenPlus}</span>
