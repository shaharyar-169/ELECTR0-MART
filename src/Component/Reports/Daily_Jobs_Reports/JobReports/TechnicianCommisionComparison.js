...
export default function TechnicianCommisionComparison() {
  ...
  function fetchDailyCashBankBalance() {
    ...
    const apiUrl = apiLinks + "/GetTechnicianCommissionJV.php";
    setIsLoading(true);
    ...
    axios
      ...
      .then((response) => {
        ...
        setTotalOpening(response.data["Total"]);
  ...
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
   ...
   const exportPDFHandler = () => {
     ...
     const columnWidths = [15, 110, 20,  30];
     ...
     const handlePagination = () => {
       ...
       while (currentPageIndex * rowsPerPage < rows.length) {
         ...
         doc.setFont("verdana-regular", "normal");
         addTitle(
           `Technician Commission Comparison: ${fromInputDate} To: ${toInputDate}`,
           "",
           "",
           pageNumber,
           startY,
     ...
     // Save the PDF files
     doc.save(`TechnicianCommissionComparison Form ${fromInputDate} To ${toInputDate}.pdf`);
   };
   ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
   ///////////////////////////// DOWNLOAD PDF EXCEL //////////////////////////////////////////////////////////
   const handleDownloadCSV = async () => {
     ...
     const storeListRow = worksheet.addRow([
       `Technician Commission Comparison From ${fromInputDate} To ${toInputDate}`,
     ]);
     ...
     // Set column widths
     [7, 45, 10, 14].forEach((width, index) => {
     ...
     saveAs(blob, `TechnicianCommissionComparison  From ${fromInputDate} To ${toInputDate}.xlsx`);
   };
   ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Technician Commmission Comparison Report" />
                  ...
                  {isLoading ? (
                    ...
                    onDoubleClick={(e) => {
                      ...
                      sessionStorage.setItem(
                        "TechnicinaCommissionComparisonData",
                        JSON.stringify({
                          code: item.ttchcod,
                      ...
                      // fixed URL open karo
                      window.open("/crystalsol/TechnicianCommissionReport", "_blank");
                    }}
                  >
                    {item.ttchcod}
                  </td>
