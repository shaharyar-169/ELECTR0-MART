...
export default function CompanyPerformanceReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/CompanyPerformance.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Company Performance Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`CompanyPerformanceReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Company Performance Report From ${fromInputDate} To ${toInputDate}`]);
        ...
        // Set column widths
        [10, 20, 12,12,12,12,12,12,12,12,12].forEach((width, index) => {
        ...
        saveAs(blob, `CompanyPerformanceReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Company Performance Report" />
