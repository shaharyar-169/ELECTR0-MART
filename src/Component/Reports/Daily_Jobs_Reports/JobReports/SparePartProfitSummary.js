...
export default function SparePartProfitSummary() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/SparePartsProfitSummary.php";
        setIsLoading(true);
        ...
        axios
            ...
            .then((response) => {
                ...
                setTotalCredit(response.data["TotalParts "]);
                setTotalQnty(response.data["TotalProfit "]);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [19, 40, 20, 25, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Spare Parts Profit Summery From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`SparePartsProfitSummary Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Spare Parts Profit Summary From ${fromInputDate} To ${toInputDate}`]);
        ...
        // Set column widths
        [8, 25, 8, 17, 17].forEach((width, index) => {
        ...
        saveAs(blob, `SparePartsProfitSummary From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Spare Parts Profit Summary" />
