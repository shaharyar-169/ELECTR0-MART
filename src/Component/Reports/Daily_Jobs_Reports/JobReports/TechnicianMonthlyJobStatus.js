...
export default function TechnicianMonthlyJobStatusReport() {
    ...
    const exportPDFHandler = () => {
        ...
        // Save the PDF files
        doc.save(`TechnicianMonthlyJobStatusReport As on ${date}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        saveAs(blob, `TechnicianMonthlyJobStatusReport As on ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
