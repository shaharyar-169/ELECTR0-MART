...
export default function ReferenceReceivableReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/ReferenceReceivable.php";
        setIsLoading(true);
        ...
        axios
            ...
            .then((response) => {
                ...
                setTotalQnty(response.data["Total Opening"]);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [19, 70, 25, 25, 25, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Reference Receivable Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
                ...
                if (searchQuery) {
                    doc.setFont(getfontstyle, 'bold'); // Set font to bold
                    doc.text(`SEARCH :`, labelsX + 130, labelsY + 8.5); // Draw bold label
                    doc.setFont(getfontstyle, 'normal'); // Reset font to normal
                    doc.text(`${search1}`, labelsX + 150, labelsY + 8.5); // Draw the value next to the label
        ...
        // Save the PDF files
        doc.save(`ReferenceReceivableReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Reference Receivable Report From ${fromInputDate} To ${toInputDate}`]);
 ...
 typeAndStoreRow3.eachCell((cell, colIndex) => {
            cell.font = { name: 'CustomFont' || "CustomFont", size: 10, bold: [4].includes(colIndex) };
        ...
        // Set column widths
        [12, 35, 15, 15, 15,15].forEach((width, index) => {
        ...
        totalRow.eachCell((cell, colNumber) => {
            ...
            if (
                ...
                colNumber === 3 || colNumber === 4 || colNumber === 5 || colNumber === 6
            ) {
        ...
        saveAs(blob, `ReferenceReceivableReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Reference Receivable Report" />
                    ...
                    >
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{totalQnty}</span>
                        </div>
                        <div
                            style={{
                                ...forthColWidth,
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{totalDebit}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{totalCredit}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{closingBalance}</span>
