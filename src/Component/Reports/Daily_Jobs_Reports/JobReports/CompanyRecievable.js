...
export default function CompanyReceivableReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/CompanyReceivable.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Company Receivable Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`CompanyReceivableReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Company Receivable Report From ${fromInputDate} To ${toInputDate}`]);
 ...
 typeAndStoreRow3.eachCell((cell, colIndex) => {
        ...
        saveAs(blob, `CompanyReceivableReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Company Receivable Report" />
