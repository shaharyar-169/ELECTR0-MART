...
export default function CategoryMonthlyJobComparison() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/CategoryMonthlyJobComparison.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Category Monthly Job Comparison Report`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`CategoryMonthlyJobComparisonReport As on ${date}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Category Monthly Job Comparison Report `]);
        ...
        saveAs(blob, `CategoryMonthlyJobComparisonReport As on ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Category Monthly Job Comparison Report" />
