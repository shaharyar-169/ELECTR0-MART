...
//                      doc.text(`${status}`, labelsX + 15, labelsY + 8.5); // Draw the value next to the label
 ...
 doc.setFont("verdana-regular", "normal");
       ...
       // Save the PDF files
       doc.save(`ReceivableAggingReport As On ${date}.pdf`);
     };
  ...
  const handleDownloadCSV = async () => {
           ...
           // Add Store List row
           const storeListRow = worksheet.addRow([`Receiable Agging Report From ${toInputDate}`]);
     ...
     "Code",
      ...
      String(total),
           ...
           saveAs(blob, `ReceivableAggingReport As on ${currentdate}.xlsx`);
       };
