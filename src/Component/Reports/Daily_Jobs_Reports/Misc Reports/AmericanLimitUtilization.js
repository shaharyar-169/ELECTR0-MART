...
export default function AmericanLimitUtilizationReport() {
...
doc.setFont("verdana-regular", "normal");
  ...
  doc.setFont("verdana-regular", "normal");
        addTitle(
          `American Limit Utilization Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
  ...
  doc.setFont("verdana-regular", "normal");
    ...
    // Save the PDF files
    doc.save(`AmericanLimitUtilizationReport As On ${date}.pdf`);
  };
 ...
 "SalMan",
    ...
    // Set column widths
    [10, 50,30,12,25,12,25,25,14,14, 14, 14, 14, ].forEach((width, index) => {
    ...
    saveAs(blob, `AmericanLimitUtilizationReport As on ${currentdate}.xlsx`);
  };
 ...
 width: "100%",
  ...
  const secondColWidth = {
    ...
    ? (isLargeScreen ? "260px" : "100px")
    : (isLargeScreen ? "290px" : "95px"),
  };
  const thirdColWidth = {
     width: isSidebarVisible
     ? (isLargeScreen ? "130px" : "80px")
    : (isLargeScreen ? "150px" : "90px"),
  };
  const forthColWidth = {
  width: isSidebarVisible
  ...
  width: isSidebarVisible ? "70px" : "100px",
   ...
   const LimitColWidth = {
  width: isSidebarVisible ? "60px" : "60px",
  };
  ...
  const sixthColWidth = {
   ...
   width: isSidebarVisible ? "75px" : "93px",
  };
    const eightColWidth = {
 width: isSidebarVisible ? "75px" : "93px",
  };
    ...
    if (tableData.length > 0) {
      const newColumns = {
        ...
        Area: tableData.map((row) => row.Area),
         Limit: tableData.map((row) => row.Limit),
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="American Limit Utilization Report" />
          <div
            className="row"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      className="border-dark"
                      style={LimitColWidth}
                      onClick={() => handleSorting("Limit")}
                    >
                      Limit{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("Limit")}
                      ></i>
                    </td>
