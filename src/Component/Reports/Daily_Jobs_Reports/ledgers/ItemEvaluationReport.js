...
export default function ItemEvaluationReport() {
    ...
    const exportPDFHandler = () => {
           ...
           const formattedTotalde = formatColumn(totalpurchase, 12);
        ...
        const columnWidths = [20, 14, 70, 18, 18, 18, 18, 18, 18, 18];
           ...
           const handlePagination = () => {
               ...
               while (currentPageIndex * rowsPerPage < rows.length) {
                   ...
                   addTitle(`Item Evaluation Report`, pageNumber, startY, 12);
                   startY += -5;
           ...
           // Save the PDF files
           doc.save(`ItemEvaluationReport As On ${currentdate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        [12, 8, 40, 11, 11, 11, 11, 11, 11, 11,11].forEach((width, index) => {
