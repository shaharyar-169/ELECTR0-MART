...
export default function ProjectLedger() {
  ...
  function fetchReceivableReport() {
    ...
    const apiUrl = apiLinks + "/ProjectLedger.php";
    setIsLoading(true);
  ...
  const options = supplierList.map((item) => ({
    value: item.tprjcod,
    label: `${item.tprjcod}-${item.tprjdsc.trim()}`,
  }));
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [24, 17, 13, 90, 23, 23, 23,23,23,23];
    ...
    // Save the PDF files
    doc.save(`ProjectLedger As On ${date}.pdf`);
  };
  ...
  const handleDownloadCSV = async () => {
    ...
    // Set column widths
    [10, 7,6, 45, 12, 12, 12,12,12,12].forEach((width, index) => {
    ...
    saveAs(blob, `ProjectLedger As On ${currentdate}.xlsx`);
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Project Ledger" />
...
//   useEffect(() => {
//     const apiUrl = apiLinks + "/GetAcitveProjects.php";
//     const formData = new URLSearchParams({
//       code: organisation.code,
//     //   FLocCod: '001',
//       // code: 'FOUTURA',
