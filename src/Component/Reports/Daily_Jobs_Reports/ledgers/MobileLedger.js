...
export default function MobileLedger() {
      ...
      try {
        ...
        if (parsedData.source === "doubleClick") {
          ...
          if (parsedData.Mobile) {
            mobileValue = parsedData.Mobile.toString()
              .replace(/\D/g, "")
              .slice(0, 11);
  ...
  const exportPDFHandler = () => {
    ...
    rows.push([
     String(formatValue(tableData.length.toLocaleString())),
      ...
      String(formatValue(TotalSaleAmount)),
      String(formatValue(TotalReturnAmount)),
      "",
      "",
    ]);
    ...
    const columnWidths = [17, 23, 110, 30, 30, 20, 30];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        let search = mobileNumber ? mobileNumber : "ALL";
 ...
 const handleDownloadCSV = async () => {
  ...
  const typeAndStoreRow3 = worksheet.addRow(["Mobile:", typesearch]);
  ...
  const headers = ["Trn#", "Date", "Item", "Sale Amt", "Return Amt", "Qnty", "Amount"];
  ...
  tableData.forEach((item) => {
    const row = worksheet.addRow([
      ...
      toNumber(item.ReturnAmt),
      toNumber(item.titmqnt),
      toNumber(item.tsalrat),
    ]);
    ...
    row.eachCell((cell, colIndex) => {
      ...
      // Apply number format (no decimals) for columns 4 to 7
  ...
  [8, 10, 45, 14, 14, 10, 14].forEach((width, index) => {
      ...
      <div style={contentStyle}>
        ...
        >
              ...
              >
                ...
                >
                  <input
                    ...
                    onKeyDown={(e) => handleToKeyPress(e, SearchRef)}
                    id="toDatePicker"
                    autoComplete="off"
                    placeholder="dd-mm-yyyy"
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="text-end" style={forthColWidth}>
                              {formatValue(item.SaleAmt)}
                            </td>
                            <td className="text-end" style={forthColWidth1}>
                              {formatValue(item.ReturnAmt)}
                            </td>
          ...
          >
            ...
            >
              <span className="mobileledger_total">{TotalReturnAmount}</span>
            </div>
            <div
              style={{
                ...fifthColWidth,
