...
export default function SupplierProgressLedger() {
  ...
  useEffect(() => {
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Supplier Progress Report From: ${toInputDate}`, pageNumber, startY, 12);
                startY += -5;
    ...
    const handleDownloadCSV = async () => {
        ...
        [comapnyname, `Supplier Progress Report From`].forEach((title, index) => {
        ...
        saveAs(blob, `SupplierProgressReport As On ${currentdate}.xlsx`);
    };
