...
export default function CustomerLedger() {
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Customer Ledger Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`CustomerLedgerReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        [comapnyname, `Customer Ledger Report From ${fromInputDate} To ${toInputDate} `].forEach((title, index) => {
        ...
        saveAs(blob, `CustomerLedgerReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
