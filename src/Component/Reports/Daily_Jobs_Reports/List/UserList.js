...
export default function UserList() {
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [22, 70, 15, 15, 23, 70, 22, 20];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`User List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`UserList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    // Set column widths
    [10, 35, 8, 8, 12, 35, 10, 10].forEach((width, index) => {
    ...
    saveAs(blob, `UserList As On ${currentdate}.xlsx`);
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
