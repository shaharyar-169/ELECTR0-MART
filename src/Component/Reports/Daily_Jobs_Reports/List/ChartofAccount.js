...
export default function ChartofAccount() {
    ...
    const exportPDFHandler = () => {
      ...
      const handlePagination = () => {
        ...
        while (currentPageIndex * rowsPerPage < rows.length) {
          ...
          // startY += 7;
          addTitle(`ChartOfAccount List`, "", "", pageNumber, startY, 14); // Render sale report title with decreased font size, provide the time, and page number
          startY += 13;
      ...
      // Save the PDF file
      doc.save("ChartOfAccountList.pdf");
    ...
    const handleDownloadCSV = async () => {
      ...
      saveAs(blob, "ChartOfAccountList.xlsx");
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
