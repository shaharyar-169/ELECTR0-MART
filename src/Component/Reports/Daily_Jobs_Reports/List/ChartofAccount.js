...
export default function ChartofAccount() {
    ...
    async function fetchGeneralLedger() {
        ...
        const apiUrl = EmartApiurl + "/ChartOfAccount.php";
        setIsLoading(true);
        try {
    ...
    const handleDownloadCSV = async () => {
        ...
        saveAs(blob, "ChartofAccount.xlsx");
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="ChartOfAccount" />
