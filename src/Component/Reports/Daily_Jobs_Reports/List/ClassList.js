...
export default function ClassList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/ClassList.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Class List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`ClassList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    // Add Store List row
    const storeListRow = worksheet.addRow(["Class List"]);
    ...
    saveAs(blob, `ClassList As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Class List" />
                ...
                >
                  <tr style={{ backgroundColor: tableHeadColor, color: "white" }}>
                    ...
                    <td
                      className="border-dark"
                      style={fifthColWidth}
                      onClick={() => handleSorting("From")}
                    >
                      From{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("From")}
                      ></i>
                    </td>
                    ...
                    <td
                      className="border-dark"
                      style={sixthColWidth}
                      onClick={() => handleSorting("To")}
                    >
                      To{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("To")}
                      ></i>
                    </td>
