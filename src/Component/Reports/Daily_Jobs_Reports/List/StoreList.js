...
export default function StoreList() {
    ...
    async function fetchGeneralLedger() {
        ...
        const apiUrl = EmartApiurl + "/StoreList.php";
        setIsLoading(true);
        try {
      ...
      const exportPDFHandler = () => {
        ...
        const columnWidths = [10, 70, 10, 20, 10, 18, 18, 20, 20,];
    ...
    const handleDownloadCSV = async () => {
        ...
        // Set column widths
        [10, 40,10,15,10,15, 15, 15, 15].forEach((width, index) => {
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td
                                            className="border-dark"
                                            style={sixthColWidth}
                                            onClick={() => handleSorting("Insert Usr")}
                                        >
                                            Insert Usr{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle"></i>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            onClick={() => handleSorting("Insert Date")}
                                        >
                                            Insert Date{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle"></i>
                                        </td>
                                        <td
                                            className="border-dark"
                                            style={eightColWidth}
                                            onClick={() => handleSorting("Udpdate Usr")}
                                        >
                                            Udpdate Usr{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle"></i>
                                        </td>
