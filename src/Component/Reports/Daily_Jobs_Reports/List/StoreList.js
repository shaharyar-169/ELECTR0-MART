...
export default function StoreList() {
    ...
    const exportPDFHandler = () => {
      ...
      const columnWidths = [10, 70, 10, 15, 10];
      ...
      const handlePagination = () => {
        ...
        while (currentPageIndex * rowsPerPage < rows.length) {
          ...
          // startY += 7;
          addTitle(`Store List`, "", "", pageNumber, startY, 14); // Render sale report title with decreased font size, provide the time, and page number
          startY += 13;
    ...
    const handleDownloadCSV = async () => {
      ...
      // Set column widths
      [10, 40, 10, 12, 5].forEach((width, index) => {
