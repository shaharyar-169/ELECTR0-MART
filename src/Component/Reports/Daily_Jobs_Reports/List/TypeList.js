...
export default function TypeList() {
    ...
    const exportPDFHandler = () => {
      ...
      const handlePagination = () => {
        ...
        while (currentPageIndex * rowsPerPage < rows.length) {
          ...
          // startY += 7;
          addTitle(`Type List`, "", "", pageNumber, startY, 14); // Render sale report title with decreased font size, provide the time, and page number
          startY += 13;
    ...
    const handleDownloadCSV = async () => {
      ...
      // Add title rows
      [comapnyname, `Type List`].forEach((title, index) => {
