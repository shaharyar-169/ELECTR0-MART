...
export default function MemberTypeList() {
    ...
    function fetchReceivableReport() {
        const apiUrl = apiLinks + "/MemberTypeList.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const headers = ["Code", "Description", "Status", "Amount"];
        const columnWidths = [22, 90, 15, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Member Type List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`MemberTypeList As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow(["Member Type List"]);
        ...
        tableData.forEach((item) => {
            const row = worksheet.addRow([item.Code, item.Description, item.Status, item.Amount]);
        ...
        // Set column widths
        [11, 50, 13, 15].forEach((width, index) => {
        ...
        saveAs(blob, `MemberTypeList As On ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Member Type List" />
