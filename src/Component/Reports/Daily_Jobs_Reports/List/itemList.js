...
export default function ItemList() {
    ...
    const exportPDFHandler = () => {
      ...
      const columnWidths = [35, 90, 25, 37, 22, 45];
                          ...
                          return (
                            ...
                            >
                              ...
                              <td
                                ...
                                title={item.Category || ""}
                              >
                                {item.Category && item.Category.trim().length > 13
                                  ? `${item.Category.trim().slice(0, 13)}...`
                                  : item.Category.trim() || ""}
                              </td>
                              ...
                              <td
                                ...
                                title={item.Type || ""}
                              >
                                {item.Type && item.Type.trim().length > 20
                                  ? `${item.Type.trim().slice(0, 20)}...`
                                  : item.Type.trim() || ""}
                              </td>
                            </tr>
                          );
