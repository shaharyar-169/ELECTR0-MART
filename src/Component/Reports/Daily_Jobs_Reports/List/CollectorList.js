...
export default function CollectorList() {
    ...
    function fetchReceivableReport() {
        const apiUrl = apiLinks + "/CollectorList.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const headers = ["Code", "Collector", "Status"];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Collector List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`CollectorList As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        saveAs(blob, `CollectorList As On ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    const handleSorting = (col) => {
        ...
        const newColumns = {
            ...
            Collector: fullRows.map((row) => row.Collector),
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Collector List" />
