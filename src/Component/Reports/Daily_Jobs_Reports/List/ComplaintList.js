...
export default function ComplaintList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/ComplaintList.php";
    setIsLoading(true);
    const formData = new URLSearchParams({
      FCptSts: transectionType,
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Complaint List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`ComplaintList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    // Store List
    const storeListRow = worksheet.addRow(["ComplaintList"]);
    ...
    saveAs(blob, `ComplaintList As On ${currentDate}.xlsx`);
  };
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Complaint List" />
