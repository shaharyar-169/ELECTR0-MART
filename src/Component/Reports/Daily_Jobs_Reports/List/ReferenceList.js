...
export default function ReferenceList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/ReferenceList.php";
    setIsLoading(true);
    const formData = new URLSearchParams({
      FRefSts: transectionType,
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Reference List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`ReferenceList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    // Store List
    const storeListRow = worksheet.addRow(["ReferenceList"]);
    ...
    saveAs(blob, `ReferenceList As On ${currentDate}.xlsx`);
  };
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Reference List" />
