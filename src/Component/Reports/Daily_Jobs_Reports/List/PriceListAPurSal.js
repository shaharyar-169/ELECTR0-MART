...
export default function PriceListAPurSale() {
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [37, 95, 25, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                if (searchQuery) {
                    doc.setFont(getfontstyle, "bold"); // Set font to bold
                    doc.text(`SEARCH :`, labelsX + 110, labelsY + 4.3); // Draw bold label
                    doc.setFont(getfontstyle, "normal"); // Reset font to normal
                    doc.text(`${search}`, labelsX + 130, labelsY + 4.3); // Draw the value next to the label
                }
    ...
    const handleDownloadCSV = async () => {
        ...
        tableData.forEach((item, index) => {
            ...
            row.eachCell((cell, colIndex) => {
                ...
                // ✅ Apply grey background for odd-numbered data rows
                if ((index + 1) % 2 == 0) {
                    cell.fill = {
                        type: "pattern",
                        pattern: "solid",
        ...
        // Set column widths
        [18, 45, 14, 14].forEach((width, index) => {
