...
export default function InstallerList() {
    ...
    const [isAscendingmanger, setisAscendingmanger] = useState(true);
    const [isAscendingcity, setisAscendingcity] = useState(true);
    const {
        isSidebarVisible,
        toggleSidebar,
        getcolor,
    ...
    function fetchReceivableReport() {
        const apiUrl = apiLinks + "/InstallarList.php";
        setIsLoading(true);
        const formData = new URLSearchParams({
            FIntSts: transectionType,
    ...
    const exportPDFHandler = () => {
        ...
        const headers = ["Code", "Installar", "Status", "Mobile", "City"];
        const columnWidths = [20, 70, 15, 22, 50 ];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Installar List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`InstallarList As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        const columnAlignments = ["left", "left", "center", "right",'left'];
        ...
        worksheet.mergeCells(`A${companyRow.number}:${String.fromCharCode(67 + numColumns - 1)}${companyRow.number}`);
        ...
        worksheet.mergeCells(`A${storeListRow.number}:${String.fromCharCode(67 + numColumns - 1)}${storeListRow.number}`);
        ...
        // Set column widths
        [10, 40, 10, 15, 25].forEach((width, index) => {
    ...
    const handleSorting = async (col) => {
        ...
        } else if (col === "Installar") {
            setisAscendingdec(newSortOrder === "ASC");
        } else if (col === "Sts") {
            setisAscendingsts(newSortOrder === "ASC");
        } else if (col === "Mobile") {
            setisAscendingmanger(newSortOrder === "ASC");
        } else if (col === "City") {
            setisAscendingcity(newSortOrder === "ASC");
        }
    };
    const firstColWidth = {
        width: "10%",
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Installar List" />
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td
                                            ...
                                            onClick={() => handleSorting("Installar")}
                                        >
                                            Installar{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle"
                                                style={{
                                        ...
                                        >
                                            ...
                                            <i className="fa-solid fa-caret-down caretIconStyle"
                                                style={{
                                                    transform: isAscendingmanger ? "rotate(0deg)" : "rotate(180deg)", // 180deg for better visual
                                                    color: isAscendingmanger ? "white" : "red",
                                                    transition: "transform 0.3s ease",
                                                }}
                                            ></i>
                                        </td>
                                        ...
                                        >
                                            ...
                                            <i className="fa-solid fa-caret-down caretIconStyle"
                                                style={{
                                                    transform: isAscendingcity ? "rotate(0deg)" : "rotate(180deg)", // 180deg for better visual
                                                    color: isAscendingcity ? "white" : "red",
                                                    transition: "transform 0.3s ease",
                                                }}
                                            ></i>
                                        </td>
