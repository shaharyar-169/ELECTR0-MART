...
export default function InstallarList() {
  ...
  const exportPDFHandler = () => {
     ...
     const doc = new jsPDF({ orientation: "landscape" }); // Fixed typo: "potraite" -> "portrait"
     ...
     const headers = ["Code", "Description", "Contact","Mobile", "CNIC","City","Sts"];
     const columnWidths = [15, 90, 40,28,35,50,10];
  ...
  doc.text(`Crystal Solution \t ${date} \t ${time}`, lineX + 2, lineY + 5);
     ...
     const handlePagination = () => {
       ...
       const addTitle = (
         ...
         // Add page numbering with total pages
         doc.setFont("verdana-regular", "normal");
         doc.setFontSize(10);
         doc.text(
  ...
  useEffect(() => {
    if (tableData.length > 0) {
      const newColumns = {
        tintcod: tableData.map((row) => row.tintcod),
        tintdsc: tableData.map((row) => row.tintdsc),
        tintper: tableData.map((row) => row.tintper),
        tmobnum: tableData.map((row) => row.tmobnum),
        tnicnum: tableData.map((row) => row.tnicnum),
        City: tableData.map((row) => row.City),
        tinssts: tableData.map((row) => row.tinssts),
      };
  ...
  const thirdColWidth = { width: "90px" };
   const forthColWidth = { width: "95px" };
    const fifthColWidth = { width: "120px" };
     const sixthColWidth = { width: "180px" };
      const seventhColWidth = { width: "45px" };
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Installsr List" />
                ...
                >
                  ...
                  >
                    <td
                      ...
                      style={firstColWidth}
                      onClick={() => handleSorting("tintcod")}
                    >
                      Code{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("tintcod")}
                      ></i>
                    </td>
                    ...
                    <td
                      ...
                      onClick={() => handleSorting("tintdsc")}
                    >
                      Description{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("tintdsc")}
                      ></i>
                    </td>
                    ...
                    <td
                      className="border-dark"
                      style={thirdColWidth}
                      onClick={() => handleSorting("tintper")}
                    >
                      Contact{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("tintper")}
                      ></i>
                    </td>
                    ...
                    >
                     ...
                     <td
                      ...
                      onClick={() => handleSorting("tinssts")}
                    >
                      Sts{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("tinssts")}
                      ></i>
                    </td>
