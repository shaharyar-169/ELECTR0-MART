...
export default function SlotList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/SlotList.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Slot List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`SlotList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Slot List" />
