...
export default function TrainerList() {
  ...
  const contentStyle = {
    ...
    width: isSidebarVisible ? "calc(82vw - 0%)" : "82vw",
    position: "relative",
    top: "40%",
  ...
  const getIconStyle = (colKey) => ({
    transform:
      columnSortOrders[colKey] === "DSC" ? "rotate(180deg)" : "rotate(0deg)",
                ...
                >
                  ...
                  >
                    ...
                    <td
                      className="border-dark"
                      style={forthColWidth}
                      onClick={() => handleSorting("Father")}
                    >
                      Father{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("Father")}
                      ></i>
                    </td>
                    ...
                    <td
                      className="border-dark"
                      style={fifthColWidth}
                      onClick={() => handleSorting("Add 1.")}
                    >
                      Address 1{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("Add 1.")}
                      ></i>
                    </td>
                    ...
                    <td
                      className="border-dark"
                      style={sixthColWidth}
                      onClick={() => handleSorting("Add 2.")}
                    >
                      Address 2{" "}
                      <i
                        className="fa-solid fa-caret-down caretIconStyle"
                        style={getIconStyle("Add 2.")}
                      ></i>
                    </td>
