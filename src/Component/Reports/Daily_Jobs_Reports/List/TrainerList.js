...
export default function TrainerList() {
    ...
    function fetchReceivableReport() {
        const apiUrl = apiLinks + "/TrainerList.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [12, 25, 15, 40, 60, 30, 24, 45, 22, 22];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Trainer List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`TrainerList As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow(["Trainer List"]);
        ...
        saveAs(blob, `TrainerList As On ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    useEffect(() => {
        if (tableData.length > 0) {
            const newColumns = {
                ...
                Father: tableData.map(row => row.Father),
                "Add 1.": tableData.map(row => row["Add 1."]),
                "Add 2.": tableData.map(row => row["Add 2."]),
    ...
    const renderTableData = () => {
        const rowCount = Math.max(
            ...
            columns.Father?.length || 0,
            columns["Add 1."]?.length || 0,
            columns["Add 2."]?.length || 0,
        ...
        for (let i = 0; i < rowCount; i++) {
            rows.push({
                ...
                Father: columns.Father[i],
                "Add 1.": columns["Add 1."][i],
                "Add 2.": columns["Add 2."][i],
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Trainer List" />
                            ...
                            >
                                ...
                                >
                                    <tr style={{ backgroundColor: tableHeadColor, color: "white" }}>
                                        {/* Code Column */}
                                        <td className="border-dark" style={firstColWidth} onClick={() => handleSorting("Code")}>
                                            Code{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Code")}></i>
                                        </td>

                                        {/* Trainer Column */}
                                        <td className="border-dark" style={secondColWidth} onClick={() => handleSorting("Trainer")}>
                                            Trainer{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Trainer")}></i>
                                        </td>

                                        {/* Status Column */}
                                        <td className="border-dark" style={thirdColWidth} onClick={() => handleSorting("Status")}>
                                            Status{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Status")}></i>
                                        </td>

                                        {/* Father Column */}
                                        <td className="border-dark" style={forthColWidth} onClick={() => handleSorting("Father")}>
                                            Father{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Father")}></i>
                                        </td>

                                        {/* Add 1. Column */}
                                        <td className="border-dark" style={fifthColWidth} onClick={() => handleSorting("Add 1.")}>
                                            Address 1{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Add 1.")}></i>
                                        </td>

                                        {/* Add 2. Column */}
                                        <td className="border-dark" style={sixthColWidth} onClick={() => handleSorting("Add 2.")}>
                                            Address 2{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Add 2.")}></i>
                                        </td>

                                        {/* Mobile Column */}
                                        <td className="border-dark" style={seventhColWidth} onClick={() => handleSorting("Mobile")}>
                                            Mobile{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Mobile")}></i>
                                        </td>

                                        {/* Email Column */}
                                        <td className="border-dark" style={eightColWidth} onClick={() => handleSorting("Email")}>
                                            Email{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Email")}></i>
                                        </td>

                                        {/* DOB Column */}
                                        <td className="border-dark" style={ninthColWidth} onClick={() => handleSorting("DOB")}>
                                            DOB{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("DOB")}></i>
                                        </td>

                                        {/* Join Date Column */}
                                        <td className="border-dark" style={tenthColWidth} onClick={() => handleSorting("Join Date")}>
                                            Join Date{" "}
                                            <i className="fa-solid fa-caret-down caretIconStyle" style={getIconStyle("Join Date")}></i>
                                        </td>
                                    </tr>
