...
export default function ManagerList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/ManagerList.php";
    setIsLoading(true);
    const formData = new URLSearchParams({
      FMgrSts: transectionType,
  ...
  const exportPDFHandler = () => {
    ...
    const headers = ["Code", "Manager", "Status"];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Manager List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`ManagerList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
       ...
       // Add Store List row
       const storeListRow = worksheet.addRow(["Manager List"]);
       ...
       tableData.forEach((item) => {
         const row = worksheet.addRow([item.Code, item.Manager, item.Status]);
       ...
       saveAs(blob, `ManagerList As On ${currentdate}.xlsx`);
     };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Manager List" />
