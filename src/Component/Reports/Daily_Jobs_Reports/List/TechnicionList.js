...
export default function TechnicianList() {
  ...
  function fetchReceivableReport() {
    const apiUrl = apiLinks + "/TechnicianList.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [13, 80, 22, 30, 35, 14];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Technician List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
    ...
    // Save the PDF files
    doc.save(`TechnicianList As On ${date}.pdf`);
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    const columnAlignments = ["left", "left", "left", "left", 'left', "center"];
    ...
    [comapnyname, `Technician List`].forEach((title, index) => {
    ...
    [10, 40, 14, 18, 30,10].forEach((width, index) => {
    ...
    saveAs(blob, `TechnicianList As On${currentdate}.xlsx`);
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
  ...
  return (
    <>
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Techni cianList" />
                      ...
                      {tableData.map((item, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="text-center" style={sixfthColWidth}>
                              {item.ttchsts}
                            </td>
                          </tr>
                        );
