...
export default function SparePartsList() {
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [18, 64, 50, 50, 18];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                doc.setFont(getfontstyle, "bold"); // Set font to bold
                doc.text(`STATUS :`, labelsX + 150, labelsY); // Draw bold label
                doc.setFont(getfontstyle, "normal"); // Reset font to normal
                doc.text(`${status}`, labelsX + 170, labelsY); // Draw the value next to the label
                ...
                if (searchQuery) {
                    doc.setFont(getfontstyle, "bold"); // Set font to bold
                    doc.text(`SEARCH :`, labelsX + 150, labelsY + 4.3); // Draw bold label
                    doc.setFont(getfontstyle, "normal"); // Reset font to normal
                    doc.text(`${search}`, labelsX + 170, labelsY + 4.3); // Draw the value next to the label
                }
    ...
    const handleDownloadCSV = async () => {
        ...
        const typeAndStoreRow = worksheet.addRow(["COMPANY :", typecompany, "", "STATUS", typestatus]);
        ...
        // Set column widths
        [12, 40, 25, 25, 12].forEach((width, index) => {
