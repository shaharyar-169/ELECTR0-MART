...
export default function MemberListCable() {
    ...
    const exportPDFHandler = () => {
        ...
        const headers = ["Code", "Member", "Status"];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Member List`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
        ...
        // Save the PDF files
        doc.save(`MemberList As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow(["Member List"]);
        ...
        tableData.forEach((item) => {
            const row = worksheet.addRow([item.Code, item.Collector, item.Status]);
        ...
        saveAs(blob, `MemberList As On ${currentdate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    const handleSorting = (col) => {
        ...
        const newColumns = {
            ...
            Member: fullRows.map((row) => row.Member),
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Members List 1" />
