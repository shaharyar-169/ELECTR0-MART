...
export default function CustomerListAmerican() {
    ...
    const [isAscendingregion, setisAscendingregion] = useState(true);
    ...
    function fetchReceivableReport() {
        const apiUrl = apiLinks + "/CustomerListAmerican.php";
        setIsLoading(true);
        const formData = new URLSearchParams({
            FCstSts: transectionType,
            FSalCod: Companyselectdata,
            FRegCod: Capacityselectdata,
            FCtyCod: Categoryselectdata,
            FSchTxt: searchQuery,
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [20, 85, 15, 22, 30, 40, 55];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`CustomerListAmerican`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += 5;
                ...
                doc.setFont(getfontstyle, "bold"); // Set font to bold
                doc.text(`SALESMAN :`, labelsX, labelsY); // Draw bold label
                doc.setFont(getfontstyle, "normal"); // Reset font to normal
                doc.text(`${typeItem}`, labelsX + 25, labelsY); // Draw the value next to the label

                doc.setFont(getfontstyle, "bold"); // Set font to bold
                doc.text(`REGION :`, labelsX + 180, labelsY); // Draw bold label
                doc.setFont(getfontstyle, "normal"); // Reset font to normal
                doc.text(`${typeText}`, labelsX + 205, labelsY); // Draw the value next to the label

                doc.setFont(getfontstyle, "bold"); // Set font to bold
                doc.text(`CITY :`, labelsX, labelsY + 4.3); // Draw bold label
                doc.setFont(getfontstyle, "normal"); // Reset font to normal
        ...
        // Save the PDF files
        doc.save(`CustomerListAmerican As On ${date}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        const columnAlignments = ["left", "left", "center", "right", "left", "left", "left"];
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow(["CustomerListAmerican"]);
        ...
        // Set column widths
        [12, 45, 8, 12, 15, 22, 25].forEach((width, index) => {
        ...
        saveAs(blob, `CustomerListAmerican As On ${currentdate}.xlsx`);
    };
    ...
    const handleSorting = async (col) => {
        ...
        const columnMappings = {
            ...
            "Customer": setisAscendingemploye,
            "Sts": setisAscendingsts,
            "Mobile": setisAscendingdesig,
            "SaleMan": setisAscendingcontect,
            "City": setisAscendingadv,
            "Region": setisAscendingregion,
    ...
    return (
        <>
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="CustomerListAmerican" />
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <i className="fa-solid fa-caret-down caretIconStyle"
                                                style={{
                                                    transform: isAscendingregion ? "rotate(0deg)" : "rotate(180deg)", // 180deg for better visual
                                                    color: isAscendingregion ? "white" : "red",
                                                    transition: "transform 0.3s ease",
                                                }}
                                            ></i>
                                        </td>
