...
export default function InstallmentCollectionMonthlyComparison() {
    ...
    const [transectionType, settransectionType] = useState("D");
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [20, 20,17,25, 25, 25, 25, 25, 25, 25, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`Installment Collection Monthly Comparison Report From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
                ...
                doc.text(`${search}`, labelsX + 27, labelsY + 8.5); // Draw the value next to the label
        ...
        // Save the PDF files
        doc.save(`InstallmentCollectionMonthlyComparisonReport Form ${fromInputDate} To ${toInputDate}.pdf`);
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Installment Collection Monthly Comparison Report From ${fromInputDate} To ${toInputDate}`]);
    ...
    let search = Companyselectdatavalue.label
        ...
        typeAndStoreRow.eachCell((cell, colIndex) => {
            cell.font = { name: 'CustomFont' || "CustomFont", size: 10, bold: [1, 9].includes(colIndex) };
        ...
        // Set column widths
        [13, 14,10,15, 15,15,15,15,15,15,15].forEach((width, index) => {
        ...
        totalRow.eachCell((cell, colNumber) => {
            ...
            if (
                ...
                colNumber === 5 || colNumber === 6 || colNumber === 7 || colNumber === 8 || colNumber === 9 || colNumber === 10 || colNumber === 11
            ) {
        ...
        saveAs(blob, `InstallmentCollectionMonthlyComparisonReport From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Installment Collection Monthly Comparison Report" />
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        onKeyDown={(e) => handleToKeyPress(e, 'tyepeselect')}
                                        id="toDatePicker"
                                        autoComplete="off"
                                        placeholder="dd-mm-yyyy"
                    ...
                    >
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{SaleCust}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalSale}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalAdvance}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalCust}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalIns}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalCol}</span>
                        ...
                        >
                            <span className="mobileledger_total" style={{ textAlign: 'left' }}>{TotalDif}</span>
