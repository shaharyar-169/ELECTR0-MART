...
setSaleCust(response.data["SaleCust"]);
   ...
   const headers = [
        ...
        const columnWidths = [23,24,20,20,25, 27, 27, 27, 27, 27, 27];
          ...
          doc.setFontSize(10);
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
              doc.setFont("Times New Roman", "normal");
                ...
                doc.setFont("verdana-regular", "normal");
                addTitle(`Installment Collection Monthly Comparison From ${fromInputDate} To ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
...
doc.setFont("verdana-regular", "normal");
        ...
        // Save the PDF files
        doc.save(`InastallmentcollectMonthlyComparison from ${fromInputDate} to ${toInputDate}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ///////////////////////////// DOWNLOAD PDF EXCEL //////////////////////////////////////////////////////////
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Installment Collection Monthly comparison From ${fromInputDate} To ${toInputDate}`]);
...
typeAndStoreRow.eachCell((cell, colIndex) => {
  ...
  cell.alignment = {
    ...
    vertical: "middle",
        ...
        // Set column widths
        [11, 12,8,10, 10, 14, 14, 14, 14, 14, 14, 14].forEach((width, index) => {
     ...
     worksheet.mergeCells(`A${dateTimeRow1.number}:${String.fromCharCode(65 + numColumns - 1)}${dateTimeRow1.number}`);
        ...
        saveAs(blob, `InstallmentCollectionMonthlyComparison From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
...
<tr
                                    ...
                                    >
                                        ...
                                        <td className="border-dark" style={secondColWidth}>
                                         ...
                                         <td className="border-dark" style={secondColWidth2}>
                                            Month #
                                        </td>
                                         <td className="border-dark" style={secondColWidth3}>
                                            CostAmt
                                        </td>
...
<table
                                            ...
                                            {tableData.map((item, i) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="text-end" style={secondColWidth3}>
                                                            {item.CostAmt}
                                                        </td>
 ...
 <div
                    ...
                    >
                        ...
                        >
                       <span className="mobileledger_total">{formatValue(SaleCust)}</span>
                        ...
                        >
                                                   <span className="mobileledger_total">{formatValue(TotalAdvance)}</span>
                        ...
                        >
                                                   <span className="mobileledger_total">{formatValue(TotalCust)}</span>
                        ...
                        >
                            <span className="mobileledger_total">{formatValue(TotalIns)}</span>
                        ...
                        >
                            <span className="mobileledger_total">{formatValue(TotalCol)}</span>
