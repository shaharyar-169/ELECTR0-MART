...
export default function DailySparePartsIssueReport() {
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/DailySparePartsIssueReport.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFontSize(10);
        addTitle(
          `Daily Spare Parts Issue Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`DailySparePartsIssueReport As On ${date}.pdf`);
  };
...
typeAndStoreRow3.eachCell((cell, colIndex) => {
  ...
  if (colIndex === 6) {
    ...
    saveAs(blob, `DailySparePartsIssueReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Daily Spare Parts Issue Report" />
