...
export default function DailyJobReport() {
    ...
    const [transectionType, settransectionType] = useState("N");
    const [transectionType2, settransectionType2] = useState("REPAIRING");
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [20, 15, 50, 23, 50, 50, 22, 20, 15];
    ...
    const handleDownloadCSV = async () => {
        ...
        // Set column widths
        [11, 7, 25, 12, 25, 20, 13, 13, 13,].forEach((width, index) => {
