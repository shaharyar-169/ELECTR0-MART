...
export default function DailySaleReportPosReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/DailySaleReportPos.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [10, 15, 40, 15, 12, 20, 30, 30, 20, 20, 20, 20, 20, 20];
        ...
        // Save the PDF files
        doc.save(`DailySaleReportPos Form ${fromInputDate} To ${toInputDate}.pdf`);
    };
    ...
    const handleDownloadCSV = async () => {
        ...
        const storeListRow = worksheet.addRow([
            `Daily Sale Report Pos From ${fromInputDate} To ${toInputDate}`,
        ]);
        ...
        // Set column widths
        [7, 23, 30, 8, 8, 10, 20,20, 12, 15, 10, 15, 15, 15].forEach((width, index) => {
        ...
        saveAs(blob, `DailySaleReportPos From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="DailySaleReportPos" />
