...
export default function DailyPurchaseDetailReportPos() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/DailyPurchaseDetailReportPos.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < transformedRows.length) {
                ...
                addTitle(
                    `DailyPurchaseDetailReportPos From: ${fromInputDate} To: ${toInputDate}`,
                    "",
                    "",
                    pageNumber,
                    startY,
