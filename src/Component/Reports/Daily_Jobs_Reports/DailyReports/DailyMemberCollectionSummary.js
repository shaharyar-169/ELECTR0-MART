...
export default function DailyMemberCollectionSummaryReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/DailyMemberCollectionSummary.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [25, 30, 20, 30];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(
                    `Member Collection Summary From ${fromInputDate} To ${toInputDate}`,
                    "",
                    "",
                    pageNumber,
                    startY,
        ...
        // Save the PDF files
        doc.save(`Member Collection Summary From ${fromInputDate} To ${toInputDate}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const contentStyle = {
        ...
        width: isSidebarVisible ? "calc(30vw - 0%)" : "30vw",
        position: "relative",
        top: "40%",
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Member Collection Summary Report" />
