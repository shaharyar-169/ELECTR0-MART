...
export default function DailySparePartsDemandReport() {
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/DailySparePartsDemandReport.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [17, 22, 13, 16, 75, 90, 18, 25];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFontSize(10);
        addTitle(
          `Daily Spare Parts Demand Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`DailySparePartsDemandReport As On ${date}.pdf`);
  };
...
worksheet.mergeCells(
  `G${typeAndStoreRow3.number}:H${typeAndStoreRow3.number}`
);
...
typeAndStoreRow3.eachCell((cell, colIndex) => {
  cell.font = {
    name: "CustomFont",
    size: 10,
    bold: colIndex === 6, // SEARCH label bold
  };
  ...
  if (colIndex === 6) {
    ...
    // Set column widths
    [8, 10, 7, 8, 35, 45, 10, 12].forEach((width, index) => {
    ...
    saveAs(blob, `DailySparePartsDemandReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Daily Spare Parts Demand Report" />
