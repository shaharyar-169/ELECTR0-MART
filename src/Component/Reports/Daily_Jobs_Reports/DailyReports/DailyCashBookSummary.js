...
export default function DailyCashBookSummary() {
    ...
    function fetchGeneralLedger() {
        ...
        const apiUrl = apiLinks + "/DailyCashBookSummary.php";
        setIsLoading(true);
    ...
    const handleDownloadCSV = async () => {
        ...
        const columnAlignments = ["right", "right", "right", 'right'];
        ...
        [
            comapnyname,
            `Daily Cash Book Summary Report: ${toInputDate}`,
        ].forEach((title, index) => {
        ...
        saveAs(blob, "DailyCashBookSummaryReport.xlsx");
    };
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Daily Cash Book Summary Report" />
