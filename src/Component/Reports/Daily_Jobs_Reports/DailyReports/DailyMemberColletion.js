...
export default function DailyMemberCollectionReport() {
    ...
    function fetchReceivableReport() {
        ...
        const apiUrl = apiLinks + "/DailyMemberCollection.php";
        setIsLoading(true);
    ...
    const exportPDFHandler = () => {
        ...
        const headers = ["Trn#", "Date", "Type", "Code", "Member", "Collection"];
        const columnWidths = [18, 22, 15, 25, 60, 25];
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(
                    `Member Collection From ${fromInputDate} To ${toInputDate}`,
                    "",
                    "",
                    pageNumber,
                    startY,
        ...
        // Save the PDF files
        doc.save(`Member Collection From ${fromInputDate} To ${toInputDate}.pdf`);
    };
    ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
    ...
    const handleDownloadCSV = async () => {
        ...
        const columnAlignments = ["left", "left", "center", "left", "left", "right"];
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`Member Collection Report From ${fromInputDate} To ${toInputDate}`]);
        ...
        // Set column widths
        [9, 12, 8, 10, 30, 15].forEach((width, index) => {
        ...
        saveAs(blob, `Member Collection Report From ${fromInputDate} To ${toInputDate}.xlsx`);
    };
    ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
    ...
    return (
        <>
            ...
            <div style={contentStyle}>
                ...
                >
                    <NavComponent textdata="Member Collection Report" />
