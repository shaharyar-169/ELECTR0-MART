            ...
            <div style={contentStyle}>
                ...
                >
                    ...
                    <div className="row " style={{ height: '20px', marginTop: '8px', marginBottom: "8px" }}>
                        <div style={{
                             width: '97.5%',
                              display: 'flex', alignItems: 'center', margin: '0px', padding: '0px', justifyContent: 'start' }}>

                            {/* To Date */}
                            <div className='d-flex align-items-center' >
                                <div style={{ width: '62px', display: 'flex', justifyContent: 'end', }}>
                            ...
                            {/* Closing Balance  */}
                            <div style={{ display: 'flex', marginLeft: '265px' }}>
                    ...
                    <div style={{ borderTop: `1px solid ${fontcolor}`, borderBottom: `1px solid ${fontcolor}`, height: '24px', display: 'flex' }}>
