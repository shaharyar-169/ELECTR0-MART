...
export default function FbrDataReport() {
    ...
    const exportPDFHandler = () => {
        ...
        const columnWidths = [50, 40, 18, 15, 25, 20, 20, 25, 15, 15, 15, 15, 15];
        ...
        const addTableRows = (startX, startY, startIndex, endIndex) => {
            ...
            for (let i = startIndex; i < endIndex; i++) {
                ...
                row.forEach((cell, cellIndex) => {
                    ...
                    } else if (cellIndex === 6 || cellIndex === 8 || cellIndex === 9 || cellIndex === 10 || cellIndex === 11 || cellIndex === 12) {
                        const rightAlignX = startX + columnWidths[cellIndex] - 2; // Adjust for right alignment
                        doc.text(cellValue, rightAlignX, cellY, {
                            align: "right",
                            baseline: "middle",
        ...
        const handlePagination = () => {
            ...
            while (currentPageIndex * rowsPerPage < rows.length) {
                ...
                addTitle(`FBR Data From: ${fromInputDate} To: ${toInputDate}`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
                startY += -5;
    ...
    const handleDownloadCSV = async () => {
        ...
        // Add Store List row
        const storeListRow = worksheet.addRow([`FBR Data Report From ${fromInputDate} To ${toInputDate}`]);
        ...
        typeAndStoreRow.eachCell((cell, colIndex) => {
            cell.font = { name: 'CustomFont' || "CustomFont", size: 10, bold: [1, 11].includes(colIndex) };
        ...
        // Set column widths
        [27, 23, 10, 8, 10, 10, 15, 12, 15, 15, 15, 15, 15].forEach((width, index) => {
        ...
        totalRow.eachCell((cell, colNumber) => {
            ...
            if (
                ...
                colNumber === 9 || colNumber === 10 || colNumber === 11 || colNumber === 12 || colNumber === 13
            ) {
                        ...
                        >
                            ...
                            <div className="d-flex align-items-center  " style={{ marginLeft: '18px' }}>
                                <div style={{ width: '90x', display: 'flex', justifyContent: 'end' }}>
                                    <label htmlFor="fromDatePicker"><span style={{ fontFamily: getfontstyle, fontSize: getdatafontsize, fontWeight: 'bold' }}>Shop :</span>  <br /></label>
                                </div>
                        ...
                        <div style={{ display: 'flex' }}>
                            <div style={{ width: "35%", marginTop: '5px' }}>
                                ...
                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>Sale # :</div>
                                    <div style={{ width: '30%', border: `1px solid ${fontcolor} `, padding: '0px', fontSize: getdatafontsize, fontFamily: getfontstyle }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].SaleNo : ''}</span>
                                ...
                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>Date :</div>
                                    <div style={{ width: '40%', border: `1px solid ${fontcolor} `, fontSize: getdatafontsize, fontFamily: getfontstyle, padding: '0px' }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].Date : ''}</span>

                                    </div>
                                </div>

                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>Mobile :</div>
                                    <div style={{ width: '40%', border: `1px solid ${fontcolor} `, fontSize: getdatafontsize, fontFamily: getfontstyle, padding: '0px' }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].Mobile : ''}</span>

                                    </div>

                                </div>
                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>Name :</div>
                                    <div style={{ width: '70%', border: `1px solid ${fontcolor} `, fontSize: getdatafontsize, fontFamily: getfontstyle, padding: '0px' }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].Customer : ''}</span>
                                ...
                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>NIC :</div>
                                    <div style={{ width: '40%', border: `1px solid ${fontcolor} `, fontSize: getdatafontsize, fontFamily: getfontstyle, padding: '0px' }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].CNIC : ''}</span>

                                    </div>

                                </div>
                                <div className="row" style={{ width: '100%', height: '24px', display: 'flex', margin: "0px" }}>
                                    <div style={{ width: '25%', textAlign: 'end', fontSize: getdatafontsize, fontFamily: getfontstyle }}>NTN :</div>
                                    <div style={{ width: '40%', border: `1px solid ${fontcolor} `, fontSize: getdatafontsize, fontFamily: getfontstyle, padding: '0px' }}>
                                        <span className="mobileledger_total1">{fbrheader.length > 0 ? fbrheader[0].NTN : ''}</span>
                            ...
                            <div style={{ width: '65%', border: '1px solid white' }}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <td className="border-dark" style={bottomseventhColWidth}>
                                                    Tax
                                                </td>
                                ...
                                >
                                    ...
                                    >
                                        <span className="mobileledger_total">{fbrTotalSaleAmt}</span>
                                    </div>
                                    ...
                                    >
                                        <span className="mobileledger_total">{fbrTotalTotalSale}</span>
                                    ...
                                    >
                                        <span className="mobileledger_total">{fbrTotalDiscount}</span>
                                    </div>
