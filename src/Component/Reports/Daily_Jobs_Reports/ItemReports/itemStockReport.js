...
export default function SparePartsStockReport() {
    ...
    function fetchDailyStatusReport() {
        ...
        axios
            ...
            .then((response) => {
                ...
                settotalexcel(response.data["Total Amount"]);
    ...
    const exportPDFHandler = () => {
        ...
        rows.push(["", "Total", "", "", String(totalqnty), String(totalexcel)]);
        ...
        const columnWidths = [20, 90, 25, 25, 14, 25];
    ...
    const handleDownloadCSV = async () => {
        ...
        const typeAndStoreRow = worksheet.addRow(
            searchQuery
                ? ["COMPANY", typecompany, "", "", "SEARCH :", typesearch]
                : ["COMPANY", typecompany]
        );
        ...
        // Set column widths
        [12, 40, 15, 15, 8, 15].forEach((width, index) => {
            worksheet.getColumn(index + 1).width = width;
        });

        const totalRow = worksheet.addRow([
            "", "Total", "", "", String(totalqnty), String(totalexcel)
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <option value="1">DEMAGE ITEM</option>
                                </select>
                            </div>
