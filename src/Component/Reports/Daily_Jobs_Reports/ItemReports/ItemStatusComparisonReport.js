...
export default function ItemStatusComparisonReport() {
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/ItemStatusComparison.php";
    setIsLoading(true);
   ...
   const addTableRows = (startX, startY, startIndex, endIndex) => {
    ...
    doc.setFont("verdana-regular", "normal");
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFont("verdana-regular", "normal");
        addTitle(
          `Slow Moving Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
        ...
        doc.setFont("verdana-regular", "normal");
        doc.setFontSize(10);
        doc.text(`${typefilter}`, labelsX + 220, labelsY + 4.3); // Draw the value next to the label
        ...
        startY += searchQuery ? 20 : 16; // Adjust vertical position for the labels
    ...
    // Save the PDF files
    doc.save(`SlowMovingReport As On ${date}.pdf`);
  };
 ...
 const handleDownloadCSV = async () => {
   ...
   const storeListRow = worksheet.addRow([
     `Slow Moving Report From ${toInputDate} To ${toInputDate}`,
   ]);
 ...
 const typeAndStoreRow = worksheet.addRow([
   ...
   saveAs(blob, `SlowMovingReport As On ${currentdate}.xlsx`);
 };
  ...
  const thirdColWidth = {
    width: isSidebarVisible ? "65px" :"82px",
  };
  const forthColWidth = {
   width: isSidebarVisible ? "65px" :"75px",
  };
  const fifthColWidth = {
  width: isSidebarVisible ? "65px" :"75px",
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Slow Moving Report" />
              ...
              <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <option value="M">SLOW MOVING</option>
