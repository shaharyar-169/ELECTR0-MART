...
export default function MonthlyItemPurchaseComparisonReport() {
  ...
  function fetchDailyStatusReport() {
    const apiUrl = apiLinks + "/MonthlyItemPurchaseComparison.php";
  ...
  const exportPDFHandler = () => {
        ...
        addTitle(
          activeIndex === 1
            ...
            : activeIndex === 2
              ...
              : `Monthly Item Purchase Sale Comparison Report`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    const pdfFileNames = {
      0: "MonthlyItemPurchaseComparison",
  ...
  const handleDownloadCSV = async () => {
    ...
    const reportTitle =
      activeIndex === 0
        ? `Monthly Item Purchase Comparison Report From ${fromInputDate} To ${toInputDate}`
        : activeIndex === 1
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent
            textdata={
              activeIndex === 0
                ? "Monthly Item Purchase Comparison Report"
                : activeIndex === 1
                  ? "Monthly Category Sale Comparison Report"
                  : activeIndex === 2
                    ? "Monthly Company Sale Comparison Report"
