...
export default function AmericanSaleReturnStoreStockReport() {
 ...
 ...(!hideCode ? ["Code"] : []),
  ...
  heading.tstrabb?.trim()
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFont("verdana-regular", "normal");
        addTitle(
          `Sale Return Store Stock Report As on ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`SaleReturnStoreStockReport As On ${toInputDate}.pdf`);
  };
  ...
  heading.tstrabb?.trim()
    ...
    saveAs(blob, `SaleReturnStoreStockReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Sale Return Store Stock Report" />
