...
export default function ItemSaleSummaryReport() {
  ...
  onClick={() => handleSorting(
    activeIndex === 0 ? "code" :
    activeIndex === 1 ? "tctgcod" :
    activeIndex === 2 ? "tcmpcod" : ""
  )}
>
  {activeIndex === 0 ? "Code" :
   activeIndex === 1 ? "Code" :
...
>
  ...
  style={sixthColWidth}
  onClick={() => handleSorting(
    activeIndex === 0 ? "Sale Amount" :
    activeIndex === 1 ? "Margin" :
    activeIndex === 2 ? "Margin" : ""
  )}
>
  {activeIndex === 0 ? "Amount" :
   activeIndex === 1 ? "Margin" :
   activeIndex === 2 ? "Margin" : ""}{" "}
