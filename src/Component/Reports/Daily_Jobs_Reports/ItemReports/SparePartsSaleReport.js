...
export default function SparePartsSaleReport() {
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/SparePartsSaleReport.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFont("verdana-regular", "normal");
        addTitle(
          `Spare Parts Sale Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`SparePartsSaleReport As On ${date}.pdf`);
  };
  ...
  const handleDownloadCSV = async () => {
    ...
    saveAs(blob, `SparePartsSaleReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Spare Parts Sale Report" />
