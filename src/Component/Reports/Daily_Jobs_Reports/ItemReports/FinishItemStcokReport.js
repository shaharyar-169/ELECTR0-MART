...
export default function FinishItemStockReport() {
  ...
  const customStyles1 = (hasError) => ({
   ...
   const exportPDFHandler = () => {
      ...
      const handlePagination = () => {
        ...
        while (currentPageIndex * rowsPerPage < rows.length) {
          ...
          doc.setFont('verdana-regular', "normal");
           doc.setFontSize(10);
          addTitle(
            `Finish Item Stock Report at ${toInputDate}`,
            "",
            "",
            pageNumber,
            startY,
      ...
      // Save the PDF files
      doc.save(`FinishItemStockReport As On ${date}.pdf`);
    };
...
typeAndStoreRow4.eachCell((cell, colIndex) => {
      ...
      saveAs(blob, `FinishItemStockReport As On ${currentdate}.xlsx`);
    };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Finish Item Stock Report" />
