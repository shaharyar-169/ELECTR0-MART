...
export default function RawMaterialStockReport() {
  ...
  const customStyles1 = (hasError) => ({
   ...
   const exportPDFHandler = () => {
      ...
      const handlePagination = () => {
        ...
        while (currentPageIndex * rowsPerPage < rows.length) {
          ...
          doc.setFont('verdana-regular', "normal");
           doc.setFontSize(10);
          addTitle(
            `Raw Material Stock Report at ${toInputDate}`,
            "",
            "",
            pageNumber,
            startY,
      ...
      // Save the PDF files
      doc.save(`RawMaterialStockReport As On ${date}.pdf`);
    };
...
typeAndStoreRow4.eachCell((cell, colIndex) => {
      ...
      saveAs(blob, `RawMaterialStockReport As On ${currentdate}.xlsx`);
    };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Raw Material Stock Report" />
