...
export default function AmericanSaleReport() {
  ...
  function fetchReceivableReport() {
    ...
    const apiUrl = apiLinks + "/AmericanItemSaleReport.php";
    setIsLoading(true);
    const formData = new URLSearchParams({
      FIntDat: fromInputDate,
      FFnlDat: toInputDate,
      // FROM & TO PUR DATE
      FCstCod: Complainselectdata,
      FSalCod: Technicianselectdata,

      FCmpCod: Companyselectdata,
      FCtgCod: Categoryselectdata,

      FRegCod: Areaselectdata,
  ...
  useEffect(() => {
    const apiUrl = apiLinks + "/GetSalesMen.php";
    const formData = new URLSearchParams({
      FLocCod: locationnumber || getLocationNumber,
      code: organisation.code,
  ...
  useEffect(() => {
    const apiUrl = apiLinks + "/GetRegions.php";
    const formData = new URLSearchParams({
      code: organisation.code,
      FLocCod: locationnumber || getLocationNumber,
    }).toString();
  ...
  const AreaDataoption = GetAreaData.map((item) => ({
    value: item.tregcod,
    label: `${item.tregcod}-${item.tregdsc}`,
  }));
  ...
  /////////////// api for City code ////////////////////
  useEffect(() => {
    const apiUrl = apiLinks + "/GetCities.php";
    const formData = new URLSearchParams({
      code: organisation.code,
      FLocCod: locationnumber || getLocationNumber,
        // code: 'AMRELEC',
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [40, 100, 20, 30];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        doc.setFont("Times New Roman", "normal"); // Set font to bold
        addTitle(comapnyname, 12, 12, pageNumber, startY, 18); // Render company title with default font size, only date, and page number
        startY += 5; // Adjust vertical position for the company title
        doc.setFont("verdana-regular", "normal"); // Set font to bold
        addTitle(`American Item Sale Report`, "", "", pageNumber, startY, 12); // Render sale report title with decreased font size, provide the time, and page number
        startY += -5;
        ...
        doc.setFont("verdana", "bold"); // Set font to bold
        doc.setFontSize(10);
        doc.text(`Salesman :`, labelsX, labelsY + 12.8); // Draw bold label
        doc.setFont("verdana-regular", "normal"); // Set font to bold
        doc.setFontSize(10);
        ...
        doc.setFont("verdana", "bold"); // Set font to bold
        doc.setFontSize(10);
        doc.text(`Customers :`, labelsX + 100, labelsY + 12.8); // Draw bold label
        doc.setFont("verdana-regular", "normal"); // Set font to bold
        doc.setFontSize(10);
        doc.text(`${complainvalue}`, labelsX + 125, labelsY + 12.5); // Draw the value next to the label
        ...
        doc.setFont("verdana", "bold"); // Set font to bold
        doc.setFontSize(10);
        doc.text(`Region :`, labelsX + 100, labelsY + 16.8); // Draw bold label
        doc.setFont("verdana-regular", "normal"); // Set font to bold
        doc.setFontSize(10);
        ...
        if (searchQuery) {
          doc.setFont("verdana", "bold"); // Set font to bold
          doc.setFontSize(10);
          doc.text(`Search :`, labelsX + 100, labelsY + 21.5); // Draw bold label
          doc.setFont("verdana-regular", "normal"); // Set font to bold
          doc.setFontSize(10);
          doc.text(`${search1}`, labelsX + 120, labelsY + 21.5); // Draw the value next to the label
        }

        // // Reset font weight to normal if necessary for subsequent text

        startY += searchQuery ? 24 : 19; // Adjust vertical position for the labels
    ...
    // Save the PDF files
    doc.save(
      `AmericanItemSaleReport From ${fromInputDate} To ${toInputDate}.pdf`,
    );
  };
  ...
  const handleDownloadCSV = async () => {
    ...
    const storeListRow = worksheet.addRow([
      `American Item Sale Report From ${fromInputDate} To ${toInputDate}`,
    ]);
    ...
    // Set column widths
    [20, 45, 10, 12].forEach((width, index) => {
    ...
    saveAs(
      blob,
      `AmericanItemSaleReport From ${fromInputDate} To ${toInputDate}.xlsx`,
    );
  };
  /////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="American Item Sale Report" />
          <div
            className="row"
              ...
              >
                ...
                <div style={{ marginLeft: "3px" }}>
                  <Select
                    ...
                    onKeyDown={(e) => handleTechnicianKeypress(e, CityRef)}
                    id="selectedsale"
                    onChange={(selectedOption) => {
                      if (selectedOption && selectedOption.value) {
                        const labelPart = selectedOption.label.split("-")[1];
                    ...
                    components={{ Option: DropdownOption }}
                    styles={{
                      ...customStyles1(!Technicianselectdata, 250),
                      placeholder: (base) => ({
                        ...base,
                        textAlign: "left",
                        marginLeft: "0",
              ...
              >
                ...
                <div style={{ marginLeft: "3px" }}>
                  <Select
                    ...
                    onKeyDown={(e) => handlecategoryKeypress(e, Complainref)}
                    id="selectedsale"
                    onChange={(selectedOption) => {
                      if (selectedOption && selectedOption.value) {
                        const labelPart = selectedOption.label.split("-")[1];
                    ...
                    components={{ Option: DropdownOption }}
                    styles={{
                      ...customStyles1(!Categoryselectdata, 250),
                      placeholder: (base) => ({
                        ...base,
                        textAlign: "left",
                        marginLeft: "0",
              ...
              >
                ...
                <div style={{ marginLeft: "3px" }}>
                  <Select
                    ...
                    components={{ Option: DropdownOption }}
                    styles={{
                      ...customStyles1(!Cityselectdata, 250),
                      placeholder: (base) => ({
                        ...base,
                        textAlign: "left",
                        marginLeft: "0",
              ...
              >
                ...
                <div style={{ marginLeft: "3px" }}>
                  <Select
                    ...
                    onKeyDown={(e) => handlecityKeypress(e, TechnicianRef)}
                    id="selectedsale"
                    onChange={(selectedOption) => {
                      if (selectedOption && selectedOption.value) {
                    ...
                    components={{ Option: DropdownOption }}
                    styles={{
                      ...customStyles1(!Complainselectdata, 430),
                      placeholder: (base) => ({
                        ...base,
                        textAlign: "left",
                        marginLeft: "0",
              ...
              >
                ...
                <div style={{ marginLeft: "3px" }}>
                  <Select
                    ...
                    onKeyDown={(e) => handleAreaKeypress(e, SearchRef)}
                    id="selectedsale"
                    onChange={(selectedOption) => {
                      if (selectedOption && selectedOption.value) {
                        const labelPart = selectedOption.label.split("-")[1];
                    ...
                    components={{ Option: DropdownOption }}
                    styles={{
                      ...customStyles1(!Areaselectdata, 250),
                      placeholder: (base) => ({
                        ...base,
                        textAlign: "left",
                        marginLeft: "0",
