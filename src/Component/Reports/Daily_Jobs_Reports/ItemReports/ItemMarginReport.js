...
export default function ItemMarginReport() {
 ...
 const [isOptionsLoaded, setIsOptionsLoaded] = useState(false);
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/ItemMarginReport.php";
    setIsLoading(true);
...
doc.setFont("verdana-regular", "normal");
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFontSize(10);
        addTitle(
          `Item Margin Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`ItemMarginReport As On ${date}.pdf`);
  };
  ...
  formatValue(item['Cost Rate']),
    ...
    saveAs(blob, `ItemMarginReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Item Margin Report" />
