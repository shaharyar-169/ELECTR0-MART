...
export default function SparePartsPurchaseSummary() {
  ...
  function fetchDailyStatusReport() {
    ...
    const apiUrl = apiLinks + "/SparePartsPurchaseSummary.php";
    setIsLoading(true);
...
const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        doc.setFont("verdana-regular", "normal");
        addTitle(
          `Spare Parts Purchase Summary Report From ${fromInputDate} To ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(`SparePartsPurchaseSummaryReport As On ${date}.pdf`);
  };
  ...
  const handleDownloadCSV = async () => {
    ...
    saveAs(blob, `SparePartsPurchaseSummaryReport As On ${currentdate}.xlsx`);
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Spare Parts Purchase Summary Report" />
